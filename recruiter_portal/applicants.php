            ...
            <div class="table-responsive">
                <table class="table table-hover js-basic-example dataTable table-custom spacing5 mb-0">
                    <tbody>
                        ...
                        <tr>
                            <td class="w60">
                                <img class="avtar-pic w35" src="../sources/assets/images/xs/avatar1.jpg" alt="">
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="w60">
                                <img class="avtar-pic w35" src="../sources/assets/images/xs/avatar2.jpg" alt="">
                            </td>
                            <td>
                                <div class="font-15">FaceBook Inc.</div>
                                <span class="text-muted">Full-stack developer</span>
                        ...
                        <tr>
                            <td class="w60">
                                <img class="avtar-pic w35" src="../sources/assets/images/xs/avatar3.jpg" alt="">
                            </td>
                            <td>
                                <div class="font-15">FaceBook Inc.</div>
                        ...
                        <tr>
                            <td class="w60">
                                <img class="avtar-pic w35" src="../sources/assets/images/xs/avatar5.jpg" alt="">
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="w60">
                                <img class="avtar-pic w35" src="../sources/assets/images/xs/avatar6.jpg" alt="">
                            </td>
                            <td>
