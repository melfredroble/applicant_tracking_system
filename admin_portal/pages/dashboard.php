                ...
                <div class="table-responsive">
                    <table class="table table-hover table-custom spacing5 mb-0">
                        <tbody>
                            <tr>
                                <td class="w40">
                                    <img src="../sources/assets/images/flag/us.svg " class="w35 rounded-circle">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../sources/assets/images/flag/au.svg" class="w35 rounded-circle">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../sources/assets/images/flag/ca.svg" class="w35 rounded-circle">
                                </td>
                                <td>
                                    <small>Canada</small>
                            ...
                            <tr>
                                <td>
                                    <img src="../sources/assets/images/flag/gb.svg" class="w35 rounded-circle">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../sources/assets/images/flag/nl.svg" class="w35 rounded-circle">
                                </td>
                                <td>
    ...
    <div class="row clearfix">
                ...
                <div class="table-responsive">
                    <table class="table table-hover js-basic-example dataTable table-custom spacing5 mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="w60">
                                    <img src="../sources/assets/images/xs/avatar1.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="w60">
                                    <img src="../sources/assets/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="w60">
                                    <img src="../sources/assets/images/xs/avatar3.jpg" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="w35 h35 rounded">
                                </td>
                                <td>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card c_grid c_yellow">
                <div class="body">
                    <div class="circle">
                        <img class="rounded-circle" src="../sources/assets/images/sm/avatar1.jpg" alt="">
                    </div>
